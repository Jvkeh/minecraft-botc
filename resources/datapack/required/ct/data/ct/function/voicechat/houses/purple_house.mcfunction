execute if score phase game_data matches 4 unless score @s[tag=!universal_vc] vc matches 9 run voicechat join "Purple House" ct
execute if score phase game_data matches 4 unless score @s[tag=universal_vc] vc matches 9 run voicechat join "Night Chat" ct
execute unless score phase game_data matches 4 unless score @s vc matches 9 run voicechat join "Purple House" ct

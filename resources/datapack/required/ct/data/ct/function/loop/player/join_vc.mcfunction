...
execute if entity @a[tag=spectator,tag=apothecary] run title @s[tag=!storyteller,tag=apothecary,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=apothecary,tag=!storyteller,tag=!spectator]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]
execute if entity @a[tag=spectator,tag=fishing_dock] run title @s[tag=!storyteller,tag=fishing_dock,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=fishing_dock,tag=!storyteller]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]
execute if entity @a[tag=spectator,tag=chapel] run title @s[tag=!storyteller,tag=chapel,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=chapel,tag=!storyteller,tag=!spectator]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]
execute if entity @a[tag=spectator,tag=crypt] run title @s[tag=!storyteller,tag=crypt,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=crypt,tag=!storyteller,tag=!spectator]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]
...
execute if entity @a[tag=spectator,tag=teapot] run title @s[tag=!storyteller,tag=teapot,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=teapot,tag=!storyteller,tag=!spectator]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]
execute if entity @a[tag=spectator,tag=cave] run title @s[tag=!storyteller,tag=cave,tag=!requesting_chat] actionbar [{"text":"\ua000","font":"ct:icons"},{"text":" ","font":"minecraft:default"},{"selector":"@a[tag=cave,tag=!storyteller,tag=!spectator]","font":"minecraft:default"},{"text":" 👁","color":"gray"}]

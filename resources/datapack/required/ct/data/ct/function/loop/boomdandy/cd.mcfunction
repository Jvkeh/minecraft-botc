...
execute if score bd_cd game_data matches 0 run particle minecraft:explosion 158.0 70.5 -2.0 10 0 10 1 75 normal @a
...
execute if score bd_cd game_data matches -5 run particle minecraft:explosion 158.0 70.5 -2.0 10 0 10 1 75 normal @a
execute if score bd_cd game_data matches -10 run title @a title {"text":"BOOM!!!","bold":true,"color":"#ff0000"}
execute if score bd_cd game_data matches -10 run particle minecraft:explosion 158.0 70.5 -2.0 10 0 10 1 75 normal @a
execute if score bd_cd game_data matches -15 run title @a title {"text":"BOOM!!!","bold":true,"color":"#ffffff"}
execute if score bd_cd game_data matches -15 run particle minecraft:explosion 158.0 70.5 -2.0 10 0 10 1 75 normal @a
execute if score bd_cd game_data matches -20 run title @a title {"text":"BOOM!!!","bold":true,"color":"#ff0000"}
execute if score bd_cd game_data matches -20 run particle minecraft:explosion 158.0 70.5 -2.0 10 0 10 1 75 normal @a

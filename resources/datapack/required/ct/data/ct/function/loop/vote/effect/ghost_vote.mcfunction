...
execute as @s[tag=dead,tag=voting_ghost] run playsound ct:clocktower.ghost_vote voice @a ~ ~ ~ 3
tag @s[tag=dead,tag=voting_ghost,tag=!active_banshee] add expended_ghost